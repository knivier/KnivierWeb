...
function goBackHome() {
    window.location.href = 'activerse.html';
}
...
function getChangelogText(versionId) {
    const changelogs = {
        ...
        <ul>
            ...
            <ul>
                <li>Viewable at <a href="https://knivier.com/Activerse/">Activerse Java Docs</a>, the Javadocs are web-viewable documents generated by Java’s own systems.</li>
            </ul>
